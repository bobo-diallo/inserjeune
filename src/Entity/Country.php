...
class Country {
    ...
    // #[ORM\OneToMany(mappedBy: 'countries', targetEntity: Prefecture::class, orphanRemoval: true)]
    // #[ORM\OneToMany(mappedBy: 'country', targetEntity: Prefecture::class, cascade: ['remove', 'persist'])]
    ...
    public function removePrefecture(Prefecture $prefecture): self
    {
        if ($this->prefectures->removeElement($prefecture)) {
            ...
            if ($prefecture->getCountries() === $this) {
                $prefecture->setCountries(null);
            }
        }
